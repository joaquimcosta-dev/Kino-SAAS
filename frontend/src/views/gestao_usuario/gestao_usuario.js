...
<button class="btn-sm btn-del" onclick="pedirDel('${f.id_fun}')">🗑 Eliminar</button>`: `<button class="btn-sm btn-criar" onclick="abrirCriar('${f.id_fun}')">➕ Criar conta</button>`;
...
if (!user) { elUser.classList.add('inv'); valido = false; } else elUser.classList.remove('inv');
